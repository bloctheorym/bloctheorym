let axios,rfgInit;_334‍.x([["fixUrl",()=>fixUrl],["isUrl",()=>isUrl],["rfgDefaults",()=>rfgDefaults],["headersToJson",()=>headersToJson],["rfgApiRequestMeta",()=>rfgApiRequestMeta],["rfgApiRequestPackage",()=>rfgApiRequestPackage],["extractZipfile",()=>extractZipfile]]);_334‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_334‍.w("rfg-api",[["default",["rfgInit"],function(v){rfgInit=v}]]);
  ...
  rfg: {
    ...
    settings: {
      ...
      errorOnImageTooSmall: false
       ...
       const headersToJson = (headers, options) => {
...
const convertToBuffer = (data) => {
  ...
  return data
       ...
       const rfgApiRequestMeta = (faviconConfig) => {
  ...
  return axios.post(faviconConfig.apiUrl, {
    ...
    requestType: 'json'
       ...
       const rfgApiRequestPackage = (faviconConfig, packageUrl) => {
