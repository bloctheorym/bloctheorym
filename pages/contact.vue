  ...
  <div><!-- mobile nav -->
                 ...
                 <div id="sidebarMenu">
                   <ul class="sidebarMenuInner">
                     ...
                     <li class="hide"><n-link class="button is-small has-text-weight-bold is-black" to="pricing" style="background-color: #6063d4;">Learn More</n-link></li>
                   </ul>
                 </div> 
                <!-- ./end mobile nav -->
                            ...
                            <article> 
                                <div class="media-content">
                                    <div class="content has-text-centered">
                                        <h1 class="title is-size-3 p-t-lg"><span style="color: #6063d4;">CONTACT US</span></h1>
                                        <p class="is-size-5 has-text-black has-text-weight-bold" style="line-height: 1.6rem;">
                                       ...
                                       <div class="gformwrap">
                                        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeF2mjqiPleUZqLr8wco6lqwhraMN_UCs1M_DhoSDqN77gwzw/viewform?embedded=true" width="100%" height="995" frameborder="0" marginheight="0" marginwidth="0" style="height: 995px !important;" scrolling="no" class="gform1">Loading...</iframe>
                                       </div>
                                    </section>
                                </div>
                                    </div>
...
<script>
import gform from "~/components/gform-contact.vue"
